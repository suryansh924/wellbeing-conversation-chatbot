...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "custom-toast group-[.error]:border-red-500 group-[.error]:bg-[#2a1a1a]",
          title: "custom-title group-[.error]:text-red-400",
          description: "custom-description group-[.error]:text-red-200",
          actionButton: "custom-action-button group-[.error]:bg-red-500 group-[.error]:hover:bg-red-600",
          cancelButton: "custom-cancel-button group-[.error]:bg-[#333] group-[.error]:text-red-200",
